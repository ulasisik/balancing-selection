...
h = as.numeric(args[2])
T_S = as.numeric(args[3]) * 1000 #time at which balanced mutation arised
r = as.numeric(args[4])
...
for(i in start:r){
  ...
  f= file(paste("/mnt/NEOGENE1/projects/deepLearn_selection_2018/50kb/scripts/simulations/SLiM_scripts/OD", T_S/1000 , h, i, sep="_"),open = "w")
